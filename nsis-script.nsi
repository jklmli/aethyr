...
;General
  ...
  ;Name and file
  Name "Aethyr"
  OutFile "aethyr-1.6.3-win3264-installer.exe"
  Icon "icon.ico"
  BrandingText "Aethyr v1.6.3 Setup"
...
Section "Aethyr" Aethyr
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\Aethyr" "DisplayVersion" "1.6.3"
